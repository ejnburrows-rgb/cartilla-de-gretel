...
const updates = {
  ...
  "l22-p80-words-c": {
    items: textItems(["cama", "cana", "cala", "loca", "casa", "saca", "coma", "cola", "cosa", "copa", "poco", "saco", "cuna", "acuso", "Cuba", "acumula", "acuna", "cubo"]),
    targets: [],
    transcriptionStatus: "verified",
    sourceStatus: "verified-source-image",
  ...
  "l22-p81-mini-story": {
    items: textItems(["carro", "coco", "casa", "Cuba", "camisa", "boca", "Colombia", "poco", "pico", "Cuco", "cuna", "saco", "roca", "cumbia", "colonia"]),
    targets: [],
    transcriptionStatus: "verified",
    sourceStatus: "verified-source-image",
    teacherNotes: "Cuco Casanova es un buen amigo... Mini story text transcribed from source image."
  },
  ...
  "l23-p84-words-y": {
    items: textItems(["yate", "yana", "Yara", "yagua", "payaso", "maya", "yegua", "Yesenia", "enyesado", "Yeyo", "yema", "yeso", "Mayito", "Yigüiro", "Yayita", "Yoyita", "Yayi", "Mayita", "cayo", "coyote", "yoyo", "yo", "rayo", "Yayo", "Yucatán", "yuca", "Cayuco", "ayuda", "ayudar", "desayuno"]),
    targets: [],
    transcriptionStatus: "verified",
    sourceStatus: "verified-source-image",
  ...
  "l23-p85-mini-story": {
    items: textItems(["yuca", "yema", "yate", "yegua", "yagua", "ayer", "payaso", "yute", "yoyo", "Yucatán", "cayo", "Mayito", "joya", "yucateco", "yeso"]),
    targets: [],
    transcriptionStatus: "verified",
    sourceStatus: "verified-source-image",
    teacherNotes: "El yate de Yayo está en Yateras... Mini story text transcribed from source image."
  },
  "l23-p86-sentences": {
