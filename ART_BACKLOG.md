...
- `feat/art-extraction-consonants` — contains 69 consonant vocabulary
  crops generated by heuristic image extraction. EVERY file must be
  opened at full resolution and visually confirmed before wiring into
  `src/content/consonants.json`. Do not wire or merge on faith.
