<!--
  PROJECT CANON — the owner's full accumulated standing rules.

  This file is the complete, word-for-word preservation of what used to
  live in CLAUDE.md before the AGENTS.md documentation standard was adopted
  (2026-07-20). Nothing was deleted; it was moved here so a one-line
  CLAUDE.md could point every agent at AGENTS.md as the single entry point
  without losing any of these hard-won, "memorized" rules.

  AGENTS.md (the single source of truth) references this file. When a rule
  here and a rule in AGENTS.md ever disagree, follow the precedence order
  stated at the top of AGENTS.md. Treat everything below as binding canon,
  not history.

  (Plain-language note for the owner: "canon" here just means your settled,
  non-negotiable rules for this project — the things you've told the agents
  to memorize.)
-->

# Cartilla de Gretel — Project Canon (formerly CLAUDE.md)
