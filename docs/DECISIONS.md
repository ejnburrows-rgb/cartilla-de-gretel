...
- **2026-08-08 — Student workbook is silent by owner direction.** Browser speech, Gretel prompts, feedback sounds, ambient/page-turn audio, and instruction speaker controls are disabled at shared sources; learning, grading, and visual feedback remain active.
- **2026-08-08 — Workbook visibility is a viewport contract.** The desktop reader sizes a spread from usable height above the fixed navigation, and lasso overlays may ring original artwork but may not duplicate, crop, or cover it.
