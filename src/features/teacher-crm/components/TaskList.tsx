  ...
  return (
    <div className="crm-card h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto space-y-3">
        {mockTasks.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center text-center p-6 border-2 border-dashed border-[#e8e2d9] rounded-xl bg-[#faf8f5]">
            <p className="text-sm font-bold text-[#3a322b] mb-1">No assignments yet.</p>
            <p className="text-xs text-[#7a7065]">
              Teacher dashboard data will appear after classes are connected.
            </p>
          </div>
        ) : (
          mockTasks.map(task => (
