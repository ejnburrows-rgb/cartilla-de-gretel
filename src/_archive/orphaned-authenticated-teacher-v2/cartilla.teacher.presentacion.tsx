          ...
          return (
            ...
            >
              ...
              <div className="mt-3 flex flex-wrap gap-2 text-xs font-bold">
                ...
                >
                  {needsSourceMapping ? "Necesita mapeo" : "Fuente conectada"}:{" "}
                ...
                {interactions.readyCount > 0 ? (
                  <span className="inline-flex items-center gap-1 rounded-full bg-emerald-100 px-3 py-1 text-emerald-900">
                    <Layers className="h-3 w-3" /> Actividad lista ({interactions.readyCount})
                  </span>
                ) : (
                  <span className="rounded-full bg-stone-100 px-3 py-1 text-stone-700">
                    Actividad generada/pendiente
                  </span>
                )}
              </div>
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-3">
        ...
        >
          ...
          <p className="mt-2 text-sm font-semibold text-foreground/68">
            Forma palabras con sílabas s, m, p
          </p>
          <div className="mt-4 flex flex-wrap gap-2">
            <a
