...
/**
 * StudentCursor — restores the large on-screen pencil for student workbook
 * screens. The native cursor is hidden only for a real mouse/trackpad; touch,
 * teacher and accessibility surfaces retain their normal system behavior.
 */
