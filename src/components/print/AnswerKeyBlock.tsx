    ...
    <div style={keyContainerStyle} className="answer-key-box">
      ...
      <div style={textContentStyle}>
        {kind === "intro" && (
          <>
            <div>
              <span style={boldLabelStyle}>Actividad: </span> Caligrafía y trazo inicial de letras
              principales:{" "}
              <span className="font-mono font-bold text-emerald-800">{syllables.join(", ")}</span>.
            </div>
            <div>
              <span style={boldLabelStyle}>Criterio de Evaluación: </span> Comprobar que el alumno
              conecte las líneas guía punteadas respetando los puntos de inicio y finalización del
              trazo.
            </div>
          </>
        )}
        ...
        {kind === "syllable_tap" && (
          <>
            <div>
              <span style={boldLabelStyle}>Respuestas de Sílabas: </span> Escribir las combinaciones
        ...
        {kind === "reading" && (
          <>
            ...
            <div className="mt-1">
              <span style={boldLabelStyle}>Copia de Dictado: </span> Evaluar caligrafía en la pauta
              de triple línea.
            </div>
          </>
        )}
