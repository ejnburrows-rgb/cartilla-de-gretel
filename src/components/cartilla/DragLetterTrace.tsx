...
// Letter stroke templates inside a 100 x 120 viewport
const LETTER_TEMPLATES: Record<string, Point[][]> = {
  A: [
    [{ x: 50, y: 20 }, { x: 35, y: 60 }, { x: 20, y: 100 }], // Left leg
    [{ x: 50, y: 20 }, { x: 65, y: 60 }, { x: 80, y: 100 }], // Right leg
    [{ x: 30, y: 65 }, { x: 50, y: 65 }, { x: 70, y: 65 }], // Cross bar
  ],
  E: [
    [{ x: 30, y: 20 }, { x: 30, y: 60 }, { x: 30, y: 100 }], // Stem
    [{ x: 30, y: 20 }, { x: 55, y: 20 }, { x: 70, y: 20 }], // Top
    [{ x: 30, y: 60 }, { x: 50, y: 60 }, { x: 65, y: 60 }], // Mid
    [{ x: 30, y: 100 }, { x: 55, y: 100 }, { x: 70, y: 100 }], // Bottom
  ],
  I: [
    [{ x: 50, y: 20 }, { x: 50, y: 60 }, { x: 50, y: 100 }], // Stem
    [{ x: 35, y: 20 }, { x: 50, y: 20 }, { x: 65, y: 20 }], // Top
    [{ x: 35, y: 100 }, { x: 50, y: 100 }, { x: 65, y: 100 }], // Bottom
  ],
  O: [
    [
      { x: 50, y: 20 },
  ...
  P: [
    [{ x: 30, y: 20 }, { x: 30, y: 60 }, { x: 30, y: 100 }], // Stem
    [{ x: 30, y: 20 }, { x: 55, y: 20 }, { x: 65, y: 35 }, { x: 55, y: 50 }, { x: 30, y: 50 }], // Loop
  ],
  S: [
    [
      { x: 70, y: 30 },
