...
describe("UI Features", () => {
  ...
  describe("Contrast Token Mapping", () => {
    it("has accessible tokens mapped in styles.css", () => {
      const css = fs.readFileSync(path.join(__dirname, "../styles.css"), "utf-8");
      expect(css).toContain("--foreground: 28 35% 18%");
      expect(css).toContain("--background: 35 60% 98%");
    });
  });
});
