...
export const PACING_CALENDAR: PacingWeek[] = [
  {
    ...
    lessonN: 1,
    focus: "intro",
    noteEs: "Establecer rutinas y conocer a Gretel.",
    noteEn: "Establish routines and meet Gretel.",
  },
  ...
  },
  {
    ...
    lessonN: null,
    focus: "assess",
    noteEs: "Evaluaci\u00f3n inicial de fonema.",
    noteEn: "Initial phoneme assessment.",
  },
  ...
  { week: 12, label: "Week 12", lessonN: 10, focus: "consonant" },
  {
    ...
    lessonN: null,
    focus: "break",
    noteEs: "Receso de Acci\u00f3n de Gracias.",
    noteEn: "Thanksgiving break.",
  },
  ...
  },
  {
    ...
    lessonN: null,
    focus: "review",
    noteEs: "Repaso de medio a\u00f1o.",
    noteEn: "Mid-year review.",
  },
  ...
  { week: 23, label: "Week 23", lessonN: 18, focus: "consonant" },
  {
    ...
    lessonN: null,
    focus: "review",
    noteEs: "Repaso de R y rr.",
    noteEn: "R and rr review.",
  },
  ...
  { week: 31, label: "Week 31", lessonN: 24, focus: "consonant" },
  {
    ...
    lessonN: null,
    focus: "review",
    noteEs: "Repaso integral.",
    noteEn: "Comprehensive review.",
  },
  {
    week: 33,
    label: "Week 33",
    lessonN: null,
    focus: "assess",
    noteEs: "Evaluaci\u00f3n final.",
    noteEn: "Final assessment.",
  },
  {
    week: 34,
    label: "Week 34",
    lessonN: null,
    focus: "review",
    noteEs: "Lectura libre y celebraci\u00f3n.",
    noteEn: "Free reading and celebration.",
  },
  {
    week: 35,
    label: "Week 35",
    lessonN: null,
    focus: "review",
    noteEs: "Portafolio del alumno.",
    noteEn: "Student portfolio.",
  },
  {
    week: 36,
    label: "Week 36",
    lessonN: null,
    focus: "review",
    noteEs: "Cierre del a\u00f1o.",
    noteEn: "End-of-year celebration.",
  },
];
