...
export const LESSONS: LessonMeta[] = [
	...
	{ n: 17, title: "Consonant Rr (soft)",    titleEs: "La consonante Rr",      letter: "Rr", kind: "consonant", pages: [59, 62], accent: "#E63946", studentBgClass: "cartilla-lesson-bg-17", teacherBgClass: "cartilla-teacher-bg-17", syllables: ["ra", "re", "ri", "ro", "ru"],          keywords: ["cara", "pera", "risa", "loro", "ruta"] },
	{ n: 18, title: "Consonant rr (strong)",  titleEs: "La consonante rr",      letter: "rr", kind: "consonant", pages: [63, 66], accent: "#F4A261", studentBgClass: "cartilla-lesson-bg-18", teacherBgClass: "cartilla-teacher-bg-18", syllables: ["rra", "rre", "rri", "rro", "rru"],     keywords: ["barra", "perro", "arriba", "carro", "arruga"] },
	{ n: 19, title: "Consonant Gg",titleEs: "La consonante Gg",      letter: "Gg", kind: "consonant", pages: [67, 70], accent: "#2A9D8F", studentBgClass: "cartilla-lesson-bg-19", teacherBgClass: "cartilla-teacher-bg-19", syllables: ["ga", "gue", "gui", "go", "gu"], keywords: ["gato", "guerra", "guitarra", "gota", "gusto"] },
	{ n: 20, title: "Consonant Ff",           titleEs: "La consonante Ff",      letter: "Ff", kind: "consonant", pages: [71, 74], accent: "#264653", studentBgClass: "cartilla-lesson-bg-20", teacherBgClass: "cartilla-teacher-bg-20", syllables: ["fa", "fe", "fi", "fo", "fu"],          keywords: ["faro", "feo", "fila", "foca", "fuente"] },
