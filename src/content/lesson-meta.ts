...
export const LESSONS: LessonMeta[] = [
	...
	{ n: 8,  title: "Consonant Pp",           titleEs: "La consonante Pp",      letter: "Pp", kind: "consonant", pages: [23, 26], accent: "#F4A261", studentBgClass: "cartilla-lesson-bg-8",  teacherBgClass: "cartilla-teacher-bg-8",  syllables: ["pa", "pe", "pi", "po", "pu"],          keywords: ["papá", "pelo", "pino", "polo", "puma"] },
	...
	{ n: 10, title: "Consonant Tt",           titleEs: "La consonante Tt",      letter: "Tt", kind: "consonant", pages: [31, 34], accent: "#264653", studentBgClass: "cartilla-lesson-bg-10", teacherBgClass: "cartilla-teacher-bg-10", syllables: ["ta", "te", "ti", "to", "tu"],          keywords: ["tapa", "tela", "tipo", "topo", "tubo"] },
	{ n: 11, title: "Consonant Dd",           titleEs: "La consonante Dd",      letter: "Dd", kind: "consonant", pages: [35, 38], accent: "#8338EC", studentBgClass: "cartilla-lesson-bg-11", teacherBgClass: "cartilla-teacher-bg-11", syllables: ["da", "de", "di", "do", "du"],          keywords: ["dado", "dedo", "dime", "dona", "duro"] },
	...
	{ n: 15, title: "Consonant Bb",           titleEs: "La consonante Bb",      letter: "Bb", kind: "consonant", pages: [51, 54], accent: "#264653", studentBgClass: "cartilla-lesson-bg-15", teacherBgClass: "cartilla-teacher-bg-15", syllables: ["ba", "be", "bi", "bo", "bu"],          keywords: ["bata", "beso", "bici", "bota", "buho"] },
	...
	{ n: 17, title: "Consonant Rr (soft)",    titleEs: "La consonante Rr",      letter: "Rr", kind: "consonant", pages: [59, 62], accent: "#E63946", studentBgClass: "cartilla-lesson-bg-17", teacherBgClass: "cartilla-teacher-bg-17", syllables: ["ra", "re", "ri", "ro", "ru"],          keywords: ["rana", "remos", "Rita", "rosa", "rueda"] },
	{ n: 18, title: "Consonant rr (strong)",  titleEs: "La consonante rr",      letter: "rr", kind: "consonant", pages: [63, 66], accent: "#F4A261", studentBgClass: "cartilla-lesson-bg-18", teacherBgClass: "cartilla-teacher-bg-18", syllables: ["rra", "rre", "rri", "rro", "rru"],     keywords: ["burro", "carrusel", "torre", "barril", "Tierra"] },
	{ n: 19, title: "Consonant Gg",titleEs: "La consonante Gg",      letter: "Gg", kind: "consonant", pages: [67, 70], accent: "#2A9D8F", studentBgClass: "cartilla-lesson-bg-19", teacherBgClass: "cartilla-teacher-bg-19", syllables: ["ga", "gue", "gui", "go", "gu"], keywords: ["gaveta", "gusano", "Goloso", "gorra", "mago"] },
	{ n: 20, title: "Consonant Ff",           titleEs: "La consonante Ff",      letter: "Ff", kind: "consonant", pages: [71, 74], accent: "#264653", studentBgClass: "cartilla-lesson-bg-20", teacherBgClass: "cartilla-teacher-bg-20", syllables: ["fa", "fe", "fi", "fo", "fu"],          keywords: ["foto", "fideos", "familia", "Felo", "funda"] },
	{ n: 21, title: "Consonant Jj",           titleEs: "La consonante Jj",      letter: "Jj", kind: "consonant", pages: [75, 78], accent: "#8338EC", studentBgClass: "cartilla-lesson-bg-21", teacherBgClass: "cartilla-teacher-bg-21", syllables: ["ja", "je", "ji", "jo", "ju"],          keywords: ["jicotea", "jugo", "Jesús", "ajo", "jarra"] },
	{ n: 22, title: "Consonant Cc",titleEs: "La consonante Cc",      letter: "Cc", kind: "consonant", pages: [79, 82], accent: "#E63946", studentBgClass: "cartilla-lesson-bg-22", teacherBgClass: "cartilla-teacher-bg-22", syllables: ["ca", "que", "qui", "co", "cu"], keywords: ["cuna", "conejo", "casa", "cubo", "Catalina"] },
	{ n: 23, title: "Consonant Yy",           titleEs: "La consonante Yy",      letter: "Yy", kind: "consonant", pages: [83, 86], accent: "#F4A261", studentBgClass: "cartilla-lesson-bg-23", teacherBgClass: "cartilla-teacher-bg-23", syllables: ["ya", "ye", "yi", "yo", "yu"],          keywords: ["yate", "yema", "Yayita", "mayúscula", "yoyo"] },
	{ n: 24, title: "Consonant Zz",           titleEs: "La consonante Zz",      letter: "Zz", kind: "consonant", pages: [87, 90], accent: "#2A9D8F", studentBgClass: "cartilla-lesson-bg-24", teacherBgClass: "cartilla-teacher-bg-24", syllables: ["za", "ce", "ci", "zo", "zu"], keywords: ["zapato", "zig-zag", "zorro", "zepelín", "Zulema"] },
];
