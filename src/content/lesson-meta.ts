...
export const LESSONS: LessonMeta[] = [
	...
	{ n: 6,  title: "Vowel U",                titleEs: "La vocal U",            letter: "U",  kind: "vowel",     pages: [16, 18], accent: "#8338ec", studentBgClass: "cartilla-lesson-bg-6",  teacherBgClass: "cartilla-teacher-bg-6",  syllables: ["u"],                                  keywords: ["uva", "uno"] },
	...
	{ n: 12, title: "Consonant Ll",           titleEs: "La consonante Ll",      letter: "Ll", kind: "consonant", pages: [39, 42], accent: "#E63946", studentBgClass: "cartilla-lesson-bg-12", teacherBgClass: "cartilla-teacher-bg-12", syllables: ["la", "le", "li", "lo", "lu"],          keywords: ["lata", "leche", "lila", "lobo", "luna"] },
	{ n: 13, title: "Consonant Nn",           titleEs: "La consonante Nn",      letter: "Nn", kind: "consonant", pages: [43, 46], accent: "#F4A261", studentBgClass: "cartilla-lesson-bg-13", teacherBgClass: "cartilla-teacher-bg-13", syllables: ["na", "ne", "ni", "no", "nu"],          keywords: ["nada", "nene", "nido", "nota", "nube"] },
	{ n: 14, title: "Consonant \u00d1\u00f1",titleEs: "La consonante \u00d1\u00f1", letter: "\u00d1\u00f1", kind: "consonant", pages: [47, 50], accent: "#2A9D8F", studentBgClass: "cartilla-lesson-bg-14", teacherBgClass: "cartilla-teacher-bg-14", syllables: ["\u00f1a", "\u00f1e", "\u00f1i", "\u00f1o", "\u00f1u"], keywords: ["\u00f1ame", "ni\u00f1o", "ca\u00f1a", "mu\u00f1eca"] },
	...
	{ n: 16, title: "Consonant Vv",           titleEs: "La consonante Vv",      letter: "Vv", kind: "consonant", pages: [55, 58], accent: "#8338EC", studentBgClass: "cartilla-lesson-bg-16", teacherBgClass: "cartilla-teacher-bg-16", syllables: ["va", "ve", "vi", "vo", "vu"],          keywords: ["vaca", "vela", "vino", "voto", "v\u00fado"] },
