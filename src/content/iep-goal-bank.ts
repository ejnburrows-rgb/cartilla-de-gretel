...
export const IEP_GOALS: IepGoal[] = [
	{
		...
		textEs: "El alumno identificar\u00e1 el sonido aislado de las 5 vocales del espa\u00f1ol con 80% de precisi\u00f3n en 4 de 5 oportunidades.",
		textEn: "The student will identify the isolated sound of the 5 Spanish vowels with 80% accuracy in 4 out of 5 opportunities.",
	...
	},
	{
		id: "ph-cv-blend",
		domain: "phonics",
		textEs: "El alumno combinar\u00e1 una consonante con cada vocal para formar s\u00edlabas CV con 80% de precisi\u00f3n en 4 de 5 oportunidades.",
		textEn: "The student will blend a consonant with each vowel to form CV syllables with 80% accuracy in 4 out of 5 opportunities.",
	...
	},
	{
		id: "ph-rr-tap",
		domain: "phonics",
		textEs: "El alumno distinguir\u00e1 entre R suave y RR fuerte en palabras orales con 80% de precisi\u00f3n.",
	...
	},
	{
		id: "fl-sentence-3w",
		domain: "fluency",
		textEs: "El alumno leer\u00e1 oraciones de 3\u20135 palabras de la cartilla con precisi\u00f3n del 90% en 3 sesiones consecutivas.",
		textEn: "The student will read 3\u20135 word cartilla sentences with 90% accuracy across 3 consecutive sessions.",
	...
	},
	{
		id: "vocab-keyword",
		domain: "vocabulary",
		textEs: "El alumno asociar\u00e1 cada palabra clave de la lecci\u00f3n con su dibujo con 90% de precisi\u00f3n.",
	...
	},
	{
		id: "engage-daily",
		domain: "engagement",
		textEs: "El alumno completar\u00e1 al menos una p\u00e1gina de la cartilla cinco d\u00edas a la semana durante cuatro semanas consecutivas.",
		textEn: "The student will complete at least one cartilla page five days per week for four consecutive weeks.",
	...
	},
	{
		id: "engage-help-seek",
		domain: "engagement",
		textEs: "El alumno solicitar\u00e1 ayuda apropiada (palabra, gesto o bot\u00f3n) cuando una p\u00e1gina sea dif\u00edcil, en 4 de 5 oportunidades.",
		textEn: "The student will request appropriate help (word, gesture, or button) when a page is difficult, in 4 of 5 opportunities.",
