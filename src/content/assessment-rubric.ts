...
export const ASSESSMENT_BANDS: AssessmentBand[] = [
  {
    ...
    letterEs: "E",
    letterEn: "A",
    percentileBand: { min: 85, max: 99 },
    descriptorEs: "Por encima del nivel.",
    descriptorEn: "Above grade level.",
  },
  {
    level: "Bien",
    numericGrade: 3,
    letterEs: "S",
    letterEn: "B",
    percentileBand: { min: 65, max: 84 },
    descriptorEs: "En nivel.",
    descriptorEn: "At grade level.",
  },
  {
    ...
    letterEs: "S",
    letterEn: "C",
    percentileBand: { min: 40, max: 64 },
    descriptorEs: "Cerca del nivel.",
    descriptorEn: "Approaching grade level.",
  },
  {
    level: "Practica",
    numericGrade: 1,
    letterEs: "N",
    letterEn: "D",
    percentileBand: { min: 20, max: 39 },
    descriptorEs: "Por debajo del nivel.",
    descriptorEn: "Below grade level.",
  },
  {
    level: "Inicial",
    numericGrade: 0,
    letterEs: "I",
    letterEn: "F",
    percentileBand: { min: 0, max: 19 },
    descriptorEs: "Muy por debajo del nivel.",
    descriptorEn: "Significantly below grade level.",
  },
];
