...
// Reviewed 2026-09-11 against the current game content and lesson order. Each
// entry is explicit so a newly introduced ahead-of-order syllable fails rather
