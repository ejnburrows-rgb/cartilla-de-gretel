...
export const ROUTINE_BLOCKS: RoutineBlock[] = [
	...
	},
	{
		...
		minutes: 7,
		descriptionEs: "Presentar la letra del d\u00eda con tarjeta grande. Modelar el sonido aislado y en palabra.",
		descriptionEn: "Introduce today's letter with a large card. Model the isolated sound and in a word.",
	...
	},
	{
		...
		minutes: 7,
		descriptionEs: "Leer la oraci\u00f3n de la p\u00e1gina mientras los alumnos siguen con el dedo.",
