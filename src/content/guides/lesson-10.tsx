    ...
    <div className="space-y-12">
        ...
        <div className="bg-orange-50/50 border border-orange-100 rounded-2xl p-6">
          <ul className="space-y-4">
            ...
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 rounded-full bg-orange-400 mt-2 shrink-0"></span>
              <span className="text-stone-700 leading-relaxed font-medium">
                Identifica y decodifica palabras con el patrón silábico "cv" (ta, te, ti, to, tu) a través de ilustraciones.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 rounded-full bg-orange-400 mt-2 shrink-0"></span>
              <span className="text-stone-700 leading-relaxed font-medium">
                Forma palabras nuevas usando combinaciones silábicas (ta, te, ti, to, tu); escribe oraciones sencillas usando mayúsculas y punto final correctamente.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 rounded-full bg-orange-400 mt-2 shrink-0"></span>
      ...
      <section id="procedimiento" className="scroll-mt-24">
        ...
        <div className="space-y-6 text-stone-700 leading-relaxed font-medium">
          <p>
            El maestro asociará "Tan tan tararán…" con el sonido del niño tocando el tambor (Flip Chart página 16).
          </p>
          <div className="bg-stone-50 border border-stone-200 rounded-2xl p-6">
            <ol className="list-decimal list-inside space-y-4">
              <li>Preguntas: ¿Qué ves en la ilustración? ¿Dónde está el niño? ¿Qué toca? ¿Cómo suena el tambor? ¿Cuántos tomates hay?</li>
              <li>Nota cultural: el tomate es una fruta y también un vegetal; se usa en ensaladas y para cocinar.</li>
              <li>Lectura (Flip Chart página 17, Libro de actividades página 33): combinaciones ta, te, ti, to, tu. Palabras de uso frecuente: "tiene, patio, no". Preguntas de comprensión sobre Tito, Tata y el topo.</li>
              <li>Rima "La sopa de pato" (Flip Chart página 18): preguntas sobre los niños, la olla, los tomates y el pato de la ilustración.</li>
        ...
        <div>
          <div className="mb-4">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="px-2.5 py-1 rounded-full bg-blue-50 text-blue-900 text-sm font-bold border border-blue-100">tiene</span>
              <span className="px-2.5 py-1 rounded-full bg-blue-50 text-blue-900 text-sm font-bold border border-blue-100">patio</span>
              <span className="px-2.5 py-1 rounded-full bg-blue-50 text-blue-900 text-sm font-bold border border-blue-100">no</span>
            </div>
          </div>
      ...
      <section id="evaluacion" className="scroll-mt-24">
        ...
        <div className="bg-purple-50 border border-purple-100 rounded-2xl p-6">
          <p className="text-purple-900 font-medium">
            <strong>Evaluación, página 10.</strong> Los estudiantes seguirán las instrucciones del maestro para completar la evaluación.
          </p>
        </div>
      </section>
