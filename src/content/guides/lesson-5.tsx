    ...
    <div className="space-y-12">
      ...
      <section id="procedimiento" className="scroll-mt-24">
        ...
        <div className="space-y-6 text-stone-700 leading-relaxed font-medium">
          <p>
            El maestro asociará el sonido <strong>Iii…</strong> con el sonido que hace la niña que llora por todo (Flip Chart página 5). La pelota arriba de la cabecita representa el punto de la letra i.
          </p>
          <div className="bg-stone-50 border border-stone-200 rounded-2xl p-6">
            <ol className="list-decimal list-inside space-y-4">
              <li>Preguntas de motivación: ¿Quién está en esta ilustración? ¿De qué color es el pantalón de la niña? ¿Qué tiene la niña en la mano? ¿Qué letra tiene la carterita de la niña? ¿Qué tiene la niña arriba de su cabecita? ¿De qué color es la pelota? ¿Por qué llora la niña? ¿En qué se parecen las ilustraciones de la letra "e" y la letra "i"? ¿En qué se diferencian la letra "o" de la letra "i"?</li>
              <li>Preguntas de vida personal: ¿Conoces tú alguna persona que llora mucho? ¿Cómo se le llama a la persona que llora mucho? ¿Cuál es tu comida preferida?</li>
              <li>Los estudiantes leen la rima e identifican las palabras que riman.</li>
              <li>Completan los ejercicios de escritura y lenguaje en las páginas 13–15 del libro de actividades.</li>
      ...
      <section id="evaluacion" className="scroll-mt-24">
        ...
        <div className="bg-purple-50 border border-purple-100 rounded-2xl p-6">
          <p className="text-purple-900 font-medium">
            <strong>Evaluación, página 5, 5a.</strong> Los estudiantes seguirán las instrucciones del maestro para completar la evaluación.
          </p>
        </div>
      </section>
