  ...
  return (
    <div className="space-y-12">
      <div className="rounded-xl border-2 border-amber-300 bg-amber-50 px-4 py-3 text-sm font-bold text-amber-800">
        ⚠️ Las páginas 20–21 del desarrollo de esta lección (la parte de motivación/lectura, entre
        la introducción de M-m y el Reforzamiento de la página 22) no aparecen en la transcripción
        ...
        <div className="bg-orange-50/50 border border-orange-100 rounded-2xl p-6">
          <ul className="space-y-4">
            ...
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 rounded-full bg-orange-400 mt-2 shrink-0"></span>
              <span className="text-stone-700 leading-relaxed font-medium">
                Identifica y decodifica palabras con el patrón silábico "cv" (ma, me, mi, mo, mu) a
            ...
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 rounded-full bg-orange-400 mt-2 shrink-0"></span>
              <span className="text-stone-700 leading-relaxed font-medium">
                Forma palabras nuevas usando sílabas simples (me, mi) o combinaciones silábicas
                (mamá, Memo); escribe oraciones sencillas usando mayúsculas y punto final
                correctamente.
              </span>
            </li>
            <li className="flex items-start gap-3">
      ...
      <section id="procedimiento" className="scroll-mt-24">
        ...
        <div className="space-y-6 text-stone-700 leading-relaxed font-medium">
          <p>
            El maestro invitará a los estudiantes a observar la ilustración de las páginas 7–9 del
            flip chart y asociará el sonido de la letra <strong>M-m</strong> con las sílabas ma, me,
            mi, mo, mu.
          </p>
          <div className="bg-stone-50 border border-stone-200 rounded-2xl p-6">
            <ol className="list-decimal list-inside space-y-4">
              <li>
                El maestro pedirá a los estudiantes que formen palabras usando las sílabas de la
                tabla silábica (página 9), las copien en la parte superior de la página 8, y
                escriban oraciones sencillas usando esas palabras en la parte inferior.
              </li>
              <li>
                El maestro reforzará el uso de la letra mayúscula al principio de la oración y en
                los nombres propios, y el uso del punto final.
              </li>
              <li>
                Completan los ejercicios de escritura y lenguaje en las páginas 19–22 del libro de
                actividades.
              </li>
      ...
      <section id="evaluacion" className="scroll-mt-24">
        ...
        <div className="bg-purple-50 border border-purple-100 rounded-2xl p-6">
          <p className="text-purple-900 font-medium">
            <strong>Evaluación, página 7.</strong> Los estudiantes seguirán las instrucciones del
