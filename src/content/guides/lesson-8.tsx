    ...
    <div className="space-y-12">
        ...
        <div className="bg-orange-50/50 border border-orange-100 rounded-2xl p-6">
          <ul className="space-y-4">
            ...
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 rounded-full bg-orange-400 mt-2 shrink-0"></span>
              <span className="text-stone-700 leading-relaxed font-medium">
                Identifica y decodifica palabras con el patrón silábico "cv" (pa, pe, pi, po, pu) a
            ...
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 rounded-full bg-orange-400 mt-2 shrink-0"></span>
              <span className="text-stone-700 leading-relaxed font-medium">
                Forma palabras nuevas usando combinaciones silábicas (pa, pe, pi, po, pu); escribe
      ...
      <section id="procedimiento" className="scroll-mt-24">
        ...
        <div className="space-y-6 text-stone-700 leading-relaxed font-medium">
          <p>
            El maestro asociará el sonido <strong>Ppp…</strong> con el sonido del globo cuando se
            explota (Flip Chart página 10): p+a=pa, p+e=pe, p+i=pi, p+o=po, p+u=pu.
          </p>
          <div className="bg-stone-50 border border-stone-200 rounded-2xl p-6">
            <ol className="list-decimal list-inside space-y-4">
              <li>
                Preguntas sobre la gallina y el pollito: ¿Qué animal es? ¿De qué color es la
                gallina? ¿Cuántas alas tiene? ¿Tiene boca o pico? ¿Dónde pone los huevos? ¿Quién
                nace de los huevos? ¿De qué color es el globo? ¿Cómo suena el globo cuando se rompe?
              </li>
              <li>
                Nota cultural: la parte amarilla del huevo se llama yema y la parte blanca se llama
                clara.
              </li>
              <li>
                Lectura (Flip Chart página 11, Libro de actividades página 25): combinaciones pa,
                pe, pi, po, pu. Palabra de uso frecuente: "Yo". Preguntas de comprensión sobre Pepe
                y Pupi.
              </li>
              <li>
                Rima "Mi papá" (Flip Chart página 12): preguntas sobre el patico, la paleta y la
                familia en la ilustración.
              </li>
              <li>
                Refuerzo: Blackline Masters páginas 8, 10 — formar y copiar palabras con las sílabas
                de la tabla, luego escribir oraciones sencillas.
              </li>
            </ol>
          </div>
        </div>
      ...
      <section id="evaluacion" className="scroll-mt-24">
        ...
        <div className="bg-purple-50 border border-purple-100 rounded-2xl p-6">
          <p className="text-purple-900 font-medium">
            <strong>Evaluación, página 8.</strong> Los estudiantes seguirán las instrucciones del
