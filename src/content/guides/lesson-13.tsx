  ...
  return (
    <div className="space-y-12">
      <div className="rounded-xl border-2 border-amber-300 bg-amber-50 px-4 py-3 text-sm font-bold text-amber-800">
        ⚠️ La página 44 de esta lección (Resumen y Motivación, antes de la sección de Lectura) no
        aparece en la transcripción disponible de la Guía del profesor — pendiente de recuperar.
      </div>
        ...
        <div className="bg-orange-50/50 border border-orange-100 rounded-2xl p-6">
          <ul className="space-y-4">
            ...
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 rounded-full bg-orange-400 mt-2 shrink-0"></span>
              <span className="text-stone-700 leading-relaxed font-medium">
                Identifica y decodifica palabras con el patrón silábico "cv" (na, ne, ni, no, nu) a
            ...
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 rounded-full bg-orange-400 mt-2 shrink-0"></span>
              <span className="text-stone-700 leading-relaxed font-medium">
                Forma palabras nuevas usando combinaciones silábicas (na, ne, ni, no, nu); escribe
      ...
      <section id="procedimiento" className="scroll-mt-24">
        ...
        <div className="space-y-6 text-stone-700 leading-relaxed font-medium">
          <p>
            Lectura (Flip Chart página 26, Libro de actividades página 45): combinaciones na, ne,
            ni, no, nu.
          </p>
          <div className="bg-stone-50 border border-stone-200 rounded-2xl p-6">
            <ol className="list-decimal list-inside space-y-4">
              <li>
                Palabras de uso frecuente: "esa, a". Preguntas de comprensión: ¿Quién da la tina?
                ¿De quién es la tina? ¿Quiénes aman a Nani? ¿Quién le pone la tina a Nani? ¿Dónde
                pone Tono la tina?
              </li>
              <li>
                Rima "¡Nada Nino!" (Flip Chart página 27): preguntas sobre la niña, la tina y el
                pato de la ilustración.
              </li>
      ...
      <section id="vocabulario" className="scroll-mt-24">
        ...
        <VocabularyList lessonNumber={13} />
        <div>
          <div className="mb-4">
      ...
      <section id="evaluacion" className="scroll-mt-24">
        ...
        <div className="bg-purple-50 border border-purple-100 rounded-2xl p-6">
          <p className="text-purple-900 font-medium">
            <strong>Evaluación, página 13.</strong> Los estudiantes seguirán las instrucciones del
