    ...
    <div className="space-y-12">
      ...
      <section id="procedimiento" className="scroll-mt-24">
        ...
        <div className="space-y-6 text-stone-700 leading-relaxed font-medium">
          <p>
            El maestro asociará el sonido <strong>Eee…</strong> con el sonido que hace la niñita que
            se agarra la orejita porque no oye bien cuando la llaman (Flip Chart página 4).
          </p>
          <div className="bg-stone-50 border border-stone-200 rounded-2xl p-6">
            <ol className="list-decimal list-inside space-y-4">
              <li>
                Preguntas de motivación: ¿Quién está en la ilustración? ¿De qué color es la blusa de
                la niña? ¿De qué color es la falda de la niña? ¿Qué tiene la niña en la mano? ¿Qué
                letra tiene la carterita de la niña? ¿Por qué la niña se pone la mano en la orejita?
                ¿Qué forma tienen las orejitas de la niña?
              </li>
              <li>
                Preguntas de vida personal: ¿Conoces tú alguna persona que no oye bien? ¿Cómo se
                llaman las personas que no oyen bien?
              </li>
              <li>Los estudiantes leen la rima e identifican las palabras que riman.</li>
              <li>
                Completan los ejercicios de escritura y lenguaje en las páginas 10–12 del libro de
                actividades.
              </li>
      ...
      <section id="evaluacion" className="scroll-mt-24">
        ...
        <div className="bg-purple-50 border border-purple-100 rounded-2xl p-6">
          <p className="text-purple-900 font-medium">
            <strong>Evaluación, página 4, 4a.</strong> Los estudiantes seguirán las instrucciones
