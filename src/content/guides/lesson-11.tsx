    ...
    <div className="space-y-12">
        ...
        <div className="bg-orange-50/50 border border-orange-100 rounded-2xl p-6">
          <ul className="space-y-4">
            ...
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 rounded-full bg-orange-400 mt-2 shrink-0"></span>
              <span className="text-stone-700 leading-relaxed font-medium">
                Identifica y decodifica palabras con el patrón silábico "cv" (da, de, di, do, du) a través de ilustraciones.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 rounded-full bg-orange-400 mt-2 shrink-0"></span>
              <span className="text-stone-700 leading-relaxed font-medium">
                Forma palabras nuevas usando combinaciones silábicas (da, de, di, do, du); escribe oraciones sencillas usando mayúsculas y punto final correctamente.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 rounded-full bg-orange-400 mt-2 shrink-0"></span>
      ...
      <section id="procedimiento" className="scroll-mt-24">
        ...
        <div className="space-y-6 text-stone-700 leading-relaxed font-medium">
          <p>
            El maestro asociará "Dan dan dararán…" con el sonido de la campana cuando la tocan (Flip Chart página 19).
          </p>
          <div className="bg-stone-50 border border-stone-200 rounded-2xl p-6">
            <ol className="list-decimal list-inside space-y-4">
              <li>Preguntas: ¿Qué ves en la ilustración? ¿Dónde está el niño? ¿Dónde hay campanas? ¿Cómo suena la campana?</li>
              <li>Nota cultural: hace muchos años en las escuelas tocaban la campana para que los niños entraran a clase y salieran al patio.</li>
              <li>Lectura (Flip Chart página 20, Libro de actividades página 37): combinaciones da, de, di, do, du. Palabras de uso frecuente: "son, están". Preguntas de comprensión sobre Ada, Dunia y Didi.</li>
              <li>Rima "Made, papá y mamá" (Flip Chart página 21): preguntas sobre la familia sentada en el banco.</li>
        ...
        <div>
          <div className="mb-4">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="px-2.5 py-1 rounded-full bg-blue-50 text-blue-900 text-sm font-bold border border-blue-100">son</span>
              <span className="px-2.5 py-1 rounded-full bg-blue-50 text-blue-900 text-sm font-bold border border-blue-100">están</span>
            </div>
          </div>
      ...
      <section id="evaluacion" className="scroll-mt-24">
        ...
        <div className="bg-purple-50 border border-purple-100 rounded-2xl p-6">
          <p className="text-purple-900 font-medium">
            <strong>Evaluación, página 11.</strong> Los estudiantes seguirán las instrucciones del maestro para completar la evaluación.
          </p>
        </div>
      </section>
