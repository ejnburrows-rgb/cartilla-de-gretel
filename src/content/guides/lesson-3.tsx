    ...
    <div className="space-y-12">
      ...
      <section id="procedimiento" className="scroll-mt-24">
        ...
        <div className="space-y-6 text-stone-700 leading-relaxed font-medium">
          <p>
            El maestro invitará a los estudiantes a observar la ilustración de la página 3 del flip chart y asociará el sonido <strong>Aaa…</strong> con el sonido que hace la niñita cuando abre la boca para que el médico le examine la garganta.
          </p>
          <div className="bg-stone-50 border border-stone-200 rounded-2xl p-6">
            <ol className="list-decimal list-inside space-y-4">
              <li>Preguntas de motivación: ¿Quiénes están en la ilustración? ¿Por qué va la niña al doctor? ¿Qué le dice el doctor a la niña? ¿Qué dice la niña cuando abre la boca? ¿Por qué el doctor usa una paletica? ¿Qué letra tiene la carterita de la niña?</li>
              <li>Preguntas de vida personal: ¿Adónde vas tú cuando estás enfermo/a? ¿Cómo se llama tu doctor?</li>
              <li>Los estudiantes leen la rima e identifican las palabras que riman.</li>
              <li>Completan los ejercicios de escritura y lenguaje en las páginas 7–9 del libro de actividades.</li>
      ...
      <section id="evaluacion" className="scroll-mt-24">
        ...
        <div className="bg-purple-50 border border-purple-100 rounded-2xl p-6">
          <p className="text-purple-900 font-medium">
            <strong>Evaluación, página 3.</strong> Los estudiantes seguirán las instrucciones del maestro para completar la evaluación.
          </p>
        </div>
      </section>
