    ...
    <div className="space-y-12">
        ...
        <div className="bg-orange-50/50 border border-orange-100 rounded-2xl p-6">
          <ul className="space-y-4">
            ...
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 rounded-full bg-orange-400 mt-2 shrink-0"></span>
              <span className="text-stone-700 leading-relaxed font-medium">
                Identifica y decodifica palabras con el patrón silábico "cv" (ba, be, bi, bo, bu) a través de ilustraciones.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 rounded-full bg-orange-400 mt-2 shrink-0"></span>
              <span className="text-stone-700 leading-relaxed font-medium">
                Forma palabras nuevas usando combinaciones silábicas (ba, be, bi, bo, bu); escribe oraciones sencillas usando mayúsculas y punto final correctamente.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 rounded-full bg-orange-400 mt-2 shrink-0"></span>
      ...
      <section id="procedimiento" className="scroll-mt-24">
        ...
        <div className="space-y-6 text-stone-700 leading-relaxed font-medium">
          <p>
            El maestro asociará el sonido <strong>Bbb…</strong> con el sonido que hace el chivito al llamar a su mamá o a los otros chivitos (Flip Chart página 31).
          </p>
          <div className="bg-stone-50 border border-stone-200 rounded-2xl p-6">
            <ol className="list-decimal list-inside space-y-4">
              <li>Preguntas: ¿Qué animal es? ¿Dónde vive el chivito? ¿Qué sonido hace? ¿Es de noche o de día?</li>
              <li>Nota cultural: a la mamá del chivito se le llama cabra; la leche de cabra es saludable para niños con problemas para tomar leche de vaca.</li>
              <li>Lectura (Flip Chart página 32, Libro de actividades página 53): combinaciones ba, be, bi, bo, bu. Palabras de uso frecuente: "alto, con". Preguntas de comprensión sobre Bebo, Pepito y Bebita.</li>
              <li>Rima "Sube la bola" (Flip Chart página 33): preguntas sobre el niño, el bate y la pelota.</li>
        ...
        <div>
          <div className="mb-4">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="px-2.5 py-1 rounded-full bg-blue-50 text-blue-900 text-sm font-bold border border-blue-100">alto</span>
              <span className="px-2.5 py-1 rounded-full bg-blue-50 text-blue-900 text-sm font-bold border border-blue-100">con</span>
            </div>
          </div>
