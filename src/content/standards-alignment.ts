...
const CONSONANT_PHONICS: StandardCode[] = [
	{
		framework: "CCSS",
		code: "RF.K.3.A",
		descriptionEs: "Demostrar conocimiento b\u00e1sico de las correspondencias entre letras y sonidos.",
	...
	},
	{
		framework: "TEKS",
		code: "\u00a7110.2.b.2.B.i",
		descriptionEs: "Identificar y unir sonidos iniciales, mediales y finales en palabras de una y dos s\u00edlabas.",
		descriptionEn: "Identify and blend initial, medial, and final sounds in one- and two-syllable words.",
	},
	{
		framework: "CA-ELD",
		code: "PI.1.6",
...
const INTRO_FOUNDATIONS: StandardCode[] = [
	{
		framework: "CCSS",
		code: "RF.K.1",
		descriptionEs: "Demostrar comprensi\u00f3n de la organizaci\u00f3n y caracter\u00edsticas del texto impreso.",
