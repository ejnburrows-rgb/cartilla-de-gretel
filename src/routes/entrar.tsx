...
/**
 * Post-splash landing — GretelPresence (real living host) + sole approved
 * greeting + high-contrast dual Entrar cards.
 *
 * Reached via the "Entrar" button on the "/" welcome splash (see
 * src/components/intro/WelcomeSplash.tsx). Kept as its own route (rather
 * than folded back into "/") so a login step can slot in between the splash
 * and this screen later without restructuring either one.
 *
