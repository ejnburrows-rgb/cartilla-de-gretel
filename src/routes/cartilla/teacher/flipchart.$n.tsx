          ...
          <div className="flex items-center justify-between gap-3 mb-3">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="text-xs font-bold text-foreground/60 border border-foreground/20 rounded px-2 py-1 hover:bg-foreground/5 transition"
              >
...
function VowelBody({
  ...
  return (
    <section className="mt-5 space-y-5">
      ...
      >
        <div className="text-sm font-bold" style={titleStyle(entry.color)}>
          {l.characterName}
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {c.syllables.map((s) => (
            <div key={s} className="rounded-2xl border-2 border-foreground/10 bg-card p-3">
              <div className="font-bold text-lg mb-1" style={titleStyle(entry.color)}>
                {s}
              </div>
