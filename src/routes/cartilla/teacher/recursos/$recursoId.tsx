...
const RECURSOS_META: Record<
  string,
  { title: string; color: string; iconColor: string; pdfPath: string }
> = {
  rimas: {
    title: "Rimas Reproducible Enriquecimiento",
    color: "bg-[#1e40af]",
    iconColor: "text-blue-200",
    pdfPath: "/teacher/rimas.pdf",
  },
  respuestas: {
    title: "Respuestas de las Evaluaciones",
    color: "bg-[#eab308]",
    iconColor: "text-yellow-100",
    pdfPath: "/teacher/respuestas.pdf",
  },
  evaluaciones: {
    title: "Evaluaciones Reproducibles",
    color: "bg-[#dc2626]",
    iconColor: "text-red-200",
    pdfPath: "/teacher/evaluaciones.pdf",
  },
  blacklines: {
    title: "Blackline Masters tablas silábicas",
    color: "bg-[#9333ea]",
    iconColor: "text-purple-200",
    pdfPath: "/teacher/blacklines.pdf",
  },
  guia: {
    title: "Guía del Profesor",
    color: "bg-[#16a34a]",
    iconColor: "text-green-200",
    pdfPath: "/teacher/guia-del-profesor.pdf",
  },
};
    ...
    <div className="w-full flex flex-col items-start py-8 h-screen max-h-screen">
      ...
      <div className="w-full flex-1 bg-stone-100 rounded-3xl border-2 border-stone-300 flex flex-col items-center justify-center text-center overflow-hidden">
        {pdfExists === null ? (
          ...
          <iframe src={meta.pdfPath} className="w-full h-full rounded-2xl" title={meta.title} />
        ) : (
          <div className="p-12">
            ...
            <p className="text-stone-500 max-w-lg mb-8">
              Aún no has subido el PDF para <b>"{meta.title}"</b> al repositorio. Por favor, sube el
              archivo a la carpeta <code>public{meta.pdfPath}</code> o compártelo en el chat para
              que la IA lo enlace.
            </p>
          </div>
        )}
