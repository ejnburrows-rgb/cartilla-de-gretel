...
export const Route = createFileRoute("/cartilla/binder")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Generador de binder de clase: páginas de texto, solucionario y hojas de trabajo en Letter." },
    ],
  }),
});
...
const printOnlyContainerStyle: React.CSSProperties = {
  display: "none",
};
...
export function TeacherBinderLayout() {
  ...
  const isIndex = location.pathname === "/cartilla/binder" || location.pathname === "/cartilla/binder/";
...
export function TeacherBinderDashboard() {
  const [selectedLessons, setSelectedLessons] = useState<Set<number>>(new Set([7])); // Pre-select lesson 7
  ...
  return (
    <div style={binderContainerStyle}>
      <div className="no-print">
        ...
        <header style={pageHeaderStyle}>
          ...
          <p className="text-stone-600 text-sm mt-1">
            Selecciona las lecciones de la Cartilla que deseas exportar. El sistema compilará un cuaderno en tamaño Carta listo para imprimir que incluye la portada del docente, el índice del cuaderno, y para cada lección seleccionada: la página original, la hoja de respuestas detallada, una ficha de ejercicios y el talón de tarea escolar para padres.
          </p>
        </header>
            ...
            return (
              ...
              >
                ...
                <div className="overflow-hidden flex-1">
                  ...
                  <h3 className="text-xs font-bold text-stone-850 truncate mt-0.5" title={entry.title}>
                    {entry.title}
                  </h3>
                </div>
              </div>
      ...
      {/* ── Print Target Container (Completely hidden on screen, active under @media print) ── */}
