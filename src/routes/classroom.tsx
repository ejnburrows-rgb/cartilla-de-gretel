  ...
  head: () => ({
    meta: [
      { title: "La Cartilla de Gretel — Láminas de clase" },
      {
        name: "description",
        content:
          "Libro de clase del maestro con vuelta vertical, lámina por lámina.",
      },
    ],
  }),
});
    ...
    },
    {
      ...
      content: (
        <article className="flex h-full flex-col justify-center">
          ...
          <h2 className="mt-4 text-7xl font-black text-[hsl(var(--vowel-o))]">
            O o
          </h2>
          <p className="mt-6 text-2xl font-bold leading-relaxed text-[hsl(28,30%,18%)]/85">
            Arre, arre, caballito,<br />vamos para Belén.
          </p>
        </article>
      ),
    },
    {
      ...
      content: (
        <article className="flex h-full flex-col justify-center">
          ...
          <h2 className="mt-4 text-7xl font-black text-[hsl(var(--vowel-a))]">
            A a
          </h2>
          <p className="mt-6 text-2xl font-bold leading-relaxed text-[hsl(28,30%,18%)]/85">
            La niña enfermita.
    ...
    },
    {
      ...
      content: (
        <article className="flex h-full flex-col justify-center">
          ...
          <h2 className="mt-4 text-7xl font-black text-[hsl(var(--vowel-e))]">
            E e
          </h2>
          <p className="mt-6 text-2xl font-bold leading-relaxed text-[hsl(28,30%,18%)]/85">
            La niña sordita.
    ...
    },
    {
      ...
      content: (
        <article className="flex h-full flex-col justify-center">
          ...
          <h2 className="mt-4 text-7xl font-black text-[hsl(var(--vowel-i))]">
            I i
          </h2>
          <p className="mt-6 text-2xl font-bold leading-relaxed text-[hsl(28,30%,18%)]/85">
            La niña llorona.
    ...
    },
    {
      ...
      content: (
        <article className="flex h-full flex-col justify-center">
          ...
          <h2 className="mt-4 text-7xl font-black text-[hsl(var(--vowel-u))]">
            U u
          </h2>
          <p className="mt-6 text-2xl font-bold leading-relaxed text-[hsl(28,30%,18%)]/85">
            La brujita.
