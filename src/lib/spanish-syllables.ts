...
function isVowel(c: string): boolean { return ALL_VOWELS.has(c.toLowerCase()); }
function isConsonant(c: string): boolean { return /[a-z\u00f1]/i.test(c) && !isVowel(c); }
