 ...
 * have to branch on which backend answered. Exercise metadata is preserved
 * because deterministic literacy insights use the recorded exercise kind to
 * point the teacher to the matching review activity. */
