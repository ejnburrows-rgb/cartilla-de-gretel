...
/**
 * Fetches /cartilla/images/source/vocales/vocales-page-01.png at runtime, measures its natural dimensions,
...
export function useBookDimensions(): {
  ...
  useEffect(() => {
    const img = new Image();
    img.src = "/cartilla/images/source/vocales/vocales-page-01.png";
    img.onload = () => {
    ...
    img.onerror = () => {
      console.warn("[flipbook] Could not probe image — using fallback ratio");
