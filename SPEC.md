...
mono, nido, yate, yoyo). Only 6 words remain genuinely unresolved: `nata`,
`pino`, `pulpo`, `sol`, `silla`, `zanahoria` — not yet page-audited. Full
detail and a ready-to-paste Antigravity prompt for those 6 are in
`ART_BACKLOG.md`.
