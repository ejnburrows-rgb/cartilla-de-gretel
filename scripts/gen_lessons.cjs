...
const lessons = [
  ...
  },
  {
    ...
    story: [
      "Ese oso pisa la sopa.",
      "Susi suma en la mesa.",
      "Susi pasea su sapo.",
      "La masa en la mesa.",
    ],
    fillInBlank: [
  ...
  },
  {
    ...
    story: [
      "Rita mira la rosa.",
      "El toro corre a la rama.",
      "La rana pasa a la rama.",
      "La ropa de Rita.",
    ],
    fillInBlank: [
      {
  ...
  },
  {
    ...
    story: [
      "La foca Fifi.",
      "Fifi sale en la foto.",
      "El faro ilumina la foca.",
      "Fifi toma café en el sofá.",
    ],
    fillInBlank: [
      {
        fullWord: "foca",
...
function generateFile(lesson) {
  ...
  const sylTapItems = lesson.syls
    .map((syl) => `{ id: "ra-${syl}", label: "${syl}" }`)
    .join(",\n      ");
