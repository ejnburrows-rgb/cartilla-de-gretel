...
def main():
    ...
    src_dir = os.path.join(base_dir, "public", "cartilla", "art", "raw", "workbook")
    dest_dir = os.path.join(base_dir, "public", "cartilla", "art", "color", "workbook")
    
    if not os.path.exists(src_dir) or len(glob.glob(os.path.join(src_dir, "*.png"))) == 0:
        print("Falling back to HD workbook directory...")
        src_dir = os.path.join(base_dir, "public", "cartilla", "art", "hd", "workbook")
