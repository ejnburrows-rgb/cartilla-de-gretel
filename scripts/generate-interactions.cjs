...
const letterMap = {
  10: {
    ...
    l: "t",
    name: "Tito",
    words: ["taza", "tomate", "tapa", "tela", "tiza", "todo", "tubo"],
    syls: ["ta", "te", "ti", "to", "tu"],
  },
  11: {
    L: "L",
    l: "l",
    name: "Lalo",
    words: ["luna", "lupa", "lata", "lobo", "loma", "lima", "lodo"],
    syls: ["la", "le", "li", "lo", "lu"],
  },
  12: {
    L: "D",
    l: "d",
    name: "Dino",
    words: ["dado", "dedo", "duda", "dama", "ducha", "doce", "dona"],
    syls: ["da", "de", "di", "do", "du"],
  },
  13: {
    L: "N",
    l: "n",
    name: "Nina",
    words: ["nido", "nudo", "nota", "nube", "niña", "nene", "nave"],
    syls: ["na", "ne", "ni", "no", "nu"],
  },
  15: {
    L: "R",
    l: "r",
    name: "Rosa",
    words: ["rana", "roca", "rama", "río", "rueda", "rata", "reloj"],
    syls: ["ra", "re", "ri", "ro", "ru"],
  },
  16: {
    L: "r",
    l: "r",
    name: "René",
    words: ["perro", "carro", "tarro", "barro", "torre", "gorra", "burro"],
    syls: ["ra", "re", "ri", "ro", "ru"],
  },
  17: {
    L: "B",
    l: "b",
    name: "Beto",
    words: ["bote", "bata", "bota", "bebé", "beso", "buho", "bola"],
    syls: ["ba", "be", "bi", "bo", "bu"],
  },
  18: {
    L: "r",
  ...
  19: {
    ...
    l: "g",
    name: "Gato",
    words: ["gato", "gota", "goma", "gusano", "gallo", "gorila", "guapa"],
    syls: ["ga", "ge", "gi", "go", "gu"],
  },
  20: {
    L: "F",
    l: "f",
    name: "Fifi",
    words: ["foca", "foto", "faro", "fuego", "fama", "fino", "fila"],
    syls: ["fa", "fe", "fi", "fo", "fu"],
  },
  21: {
    L: "J",
    l: "j",
    name: "Julio",
    words: ["jugo", "jirafa", "jefe", "jabon", "jaula", "juego", "joya"],
    syls: ["ja", "je", "ji", "jo", "ju"],
  },
  22: {
    L: "C",
    l: "c",
    name: "Cuca",
    words: ["casa", "cuna", "cama", "copa", "cola", "caja", "cara"],
    syls: ["ca", "ce", "ci", "co", "cu"],
  },
  23: {
    L: "Y",
    l: "y",
    name: "Yoli",
    words: ["yoyo", "yate", "yema", "yegua", "yeso", "yogur", "yuca"],
    syls: ["ya", "ye", "yi", "yo", "yu"],
  },
  24: {
    L: "Z",
    l: "z",
    name: "Zorro",
    words: ["zapato", "zorro", "zumo", "zona", "zanahoria", "zueco", "zarza"],
    syls: ["za", "ze", "zi", "zo", "zu"],
  },
};
        ...
        targets: [
          {
            id: "blank-1",
            label: "___",
            correctSyllable: m.words[0],
            fullWord: m.words[0],
            coordinatesVerified: false,
            acceptsItemId: `word-${m.words[0]}`,
          },
          {
            id: "blank-2",
            label: "___",
            correctSyllable: m.words[1],
            fullWord: m.words[1],
            coordinatesVerified: false,
            acceptsItemId: `word-${m.words[1]}`,
          },
          {
            id: "blank-3",
            label: "___",
            correctSyllable: m.words[2],
            fullWord: m.words[2],
            coordinatesVerified: false,
            acceptsItemId: `word-${m.words[2]}`,
          },
        ],
        exercises: [
          {
            partial: `Yo tengo un ___`,
            choices: [m.words[0], m.words[1]],
            answer: m.words[0],
            fullWord: m.words[0],
          },
          {
            partial: `Me gusta el ___`,
            choices: [m.words[1], m.words[2]],
            answer: m.words[1],
            fullWord: m.words[1],
          },
          {
            partial: `Mira esa ___`,
            choices: [m.words[2], m.words[0]],
            answer: m.words[2],
            fullWord: m.words[2],
          },
        ],
